...
const translations: TranslationsDictionary = {
  ...
  ku: {
    ...
    'projects.desc': 'شانازی دەکەین بە کارکردن لەگەڵ گەورەترین کۆمپانیاکانی عێراق بۆ دابینکردنی چارەسەری کێشانی دروست و متمانەپێکراو.',
    'proj1.title': 'قەپانی بارهەڵگر 100 تەن',
    'proj1.cat': 'دانانی نوێ',
    'proj1.loc': 'هەولێر - کۆمەڵگەی پیشەسازی',
    'proj2.title': 'سیستەمی کێشانی کۆگا',
    'proj2.cat': 'ئۆتۆماتیکی',
