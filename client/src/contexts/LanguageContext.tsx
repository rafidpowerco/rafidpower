...
const translations: TranslationsDictionary = {
  ar: {
    ...
    'projects.label': 'إنجازاتنا',
    'projects.title1': 'مشاريع',
    'projects.title2': 'تم تنفيذها',
    'projects.desc': 'فخورون بالعمل مع كبرى الشركات في العراق لتوفير حلول وزن دقيقة وموثوقة.',
    'proj1.title': 'ميزان جسري 100 طن',
    'proj1.cat': 'تركيب جديد',
    'proj1.loc': 'أربيل - مجمع صناعي',
    'proj2.title': 'نظام أوزان مخزنية',
    'proj2.cat': 'أتمتة',
    'proj2.loc': 'السليمانية - مستودعات',
    'proj3.title': 'صيانة ومعايرة دورية',
    'proj3.cat': 'صيانة',
    'proj3.loc': 'دهوك - موقع نفطي',
    'proj4.title': 'ميزان شاحنات ذكي',
    'proj4.cat': 'تركيب متطور',
    'proj4.loc': 'بغداد - مركز لوجستي',
    'proj5.title': 'تطوير رؤوس الموازين',
    'proj5.cat': 'تحديث أنظمة',
    'proj5.loc': 'الموصل - معامل أغذية',
    'proj6.title': 'ميزان منصة هيدروليكي',
    'proj6.cat': 'حلول مخصصة',
    'proj6.loc': 'ناحية خورمال - مشاريع زراعية',
    'form.msg': 'الرسالة',
  ...
  en: {
    ...
    'projects.label': 'Our Achievements',
    'projects.title1': 'Completed',
    'projects.title2': 'Projects',
    'projects.desc': 'Proud to work with major companies in Iraq to provide accurate and reliable weighing solutions.',
    'proj1.title': '100 Ton Truck Scale',
    'proj1.cat': 'New Installation',
    'proj1.loc': 'Erbil - Industrial Complex',
    'proj2.title': 'Warehouse Weighing System',
    'proj2.cat': 'Automation',
    'proj2.loc': 'Sulaymaniyah - Warehouses',
    'proj3.title': 'Periodic Maintenance & Calibration',
    'proj3.cat': 'Maintenance',
    'proj3.loc': 'Duhok - Oil Site',
    'proj4.title': 'Smart Truck Scale',
    'proj4.cat': 'Advanced Install',
    'proj4.loc': 'Baghdad - Logistics Center',
    'proj5.title': 'Scale Indicators Upgrade',
    'proj5.cat': 'System Update',
    'proj5.loc': 'Mosul - Food Factories',
    'proj6.title': 'Hydraulic Platform Scale',
    'proj6.cat': 'Custom Solutions',
    'proj6.loc': 'Khurmal - Agricultural Projects',
  ...
  ku: {
    ...
    'hero.desc': 'ئێمە ئەزموونی درێژخایەن و تەکنەلۆجیای سەردەم تێکەڵ دەکەین بۆ پێشکەشکردنی وردبینییەکی بێوێنە لە کێشانی بارهەڵگرەکان',
    'hero.explore': 'خزمەتگوزارییەکانمان ببینە',
    'hero.scrollDown': 'بۆ خوارەوە بڕۆ',
    'about.title': 'چیرۆکی ئێمە',
    'about.subtitle': 'بنیاتنانی متمانە لە ساڵی ١٩٨٨ەوە',
    'about.desc': 'ئێمە لە کۆمپانیای ڕافیدەین بۆ تەرازوو، شانازی دەکەین بەوەی پێشەنگین لە دروستکردن و چاککردنەوەی تەرازووی پردی (قەپان). بەرزترین پێوەرەکانی کوالێتی جیهانی جێبەجێ دەکەین بۆ دەستەبەرکردنی وردبینییەکی بێوێنە و چارەسەری درێژخایەن.',
    'about.item1': 'دامەزراندن لە ساڵی ١٩٨٨ بە دروشمی هەمیشەیی: (دروستی و سەلامەتی)',
    ...
    'about.item5': 'گەرەنتییەکی گشتگیر و ڕاستەقینە بۆ ماوەی ١٠ ساڵ بۆ تەرازووەکان',
    'about.item6': 'بەڕێوەبردن لەلایەن ئەندازیاری شارەزا عەبدولوەهاب زەنون',
    'products.tag': 'بەرهەمەکانمان',
    'products.title': 'چارەسەری پێشکەوتووی',
    'products.title2': 'کێشان',
    'products.desc': 'کۆمەڵەیەکی گشتگیر لە بەرهەمی پیشەسازی پێشکەش دەکەین بۆ پاڵپشتیکردنی کارەکانتان',
    'product.1.title': 'تەرازووی بارهەڵگر (قەپان)',
    'product.1.desc': 'دروستکردنی پێکهاتەی ئاسنی زەبەلاح بۆ کێشانی بارهەڵگر، کە نەخشێنراوە بۆ بەرگەگرتنی سەختترین بارودۆخەکانی کارکردنی پیشەسازی.',
    'product.1.cap': 'تا ١٥٠ تۆن',
    'product.1.acc': 'گەرەنتی ١٠ ساڵ',
    'product.2.title': 'هەستەوەری دیجیتاڵی (Load Cells)',
    'product.2.desc': 'هەستەوەر و سیستەمی ئەلیکترۆنی زۆر ورد، دژە لەرزینە بۆ دڵنیابوون لە خوێندنەوەی دروست لە هەموو کاتێکدا.',
    'product.2.cap': 'وردبینی بێوێنە',
    'product.2.acc': 'متمانەی جیهانی',
    'product.3.title': 'سیستەمی ئۆتۆمەیشن (PLC Control)',
    'product.3.desc': 'چارەسەری کۆنترۆڵی زیرەک بۆ بەستنەوەی تەرازوو بە هێڵی بەرهەمهێنانەوە بە شێوەیەکی زۆر نەرم و ئاسان.',
    ...
    'features.desc': 'ئێمە تەنیا تەرازوو نافرۆشین، بەڵکو چارەسەری ئەندازیاری گشتگیر پێشکەش دەکەین کە دڵنیایی وردبینی کارەکانتان دەدات.',
    'feat.1.t': 'وردبینی لە ڕادەبەدەر',
    'feat.1.d': 'نوێترین تەکنەلۆجیای گۆڕینی دیجیتاڵی بەکاردەهێنین بۆ دەستەبەرکردنی وردترین ئەنجامەکان لە بازاڕدا.',
    'feat.2.t': 'کوالێتی باوەڕپێکراو',
    'feat.2.d': 'هەموو بەرهەمەکانمان پێوەری OIMLی جیهانی تێدەپەڕێنن و گەرەنتییەکی گشتگیر لەخۆدەگرن.',
    'feat.3.t': 'ئەزموونی درێژخایەن',
    'feat.3.d': 'زیاتر لە ٣٥ ساڵ خزمەتکردن بە کەرتی پیشەسازی عێراقی و هەرێمی.',
    'feat.4.t': 'جێبەجێکردنی خێرا',
    'feat.4.d': 'پابەندین بە کاتەکانی دانان و چاککردنەوە بۆ دڵنیابوون لەوەی کارەکانتان هەرگیز نەوەستێت.',
    'feat.5.t': 'تەکنەلۆجیای سەردەم',
    'feat.5.d': 'چاودێری نوێترین داهێنانەکان دەکەین لە بواری تەرازووی پردی و سیستەمەکانی ئۆتۆمەیشن.',
    'feat.6.t': 'پاڵپشتی تەکنیکی',
    'feat.6.d': 'تیمێکی تەکنیکی ئامادە بۆ وەڵامدانەوەی خێرا و دابینکردنی پارچەی یەدەکی ئەسڵی بۆ هەمیشە.',
    'stat.1': 'ساڵ ئەزموون',
    'stat.2': 'تەرازوو دانراوە',
    'stat.3': 'کڕیاری ڕازی',
    'stat.4': 'بڕوانامەی کوالێتی',
    'stat.5': 'فۆڵۆوەری فەیسبووک',
    'contact.title': 'پەیوەندیمان پێوە بکە',
    'contact.desc': 'ئێمە لێرەین بۆ وەڵامدانەوەی پرسیارەکانتان و یارمەتیدانتان.',
    'form.send': 'نامەیەکمان بۆ بنێرە',
    'form.name': 'ناوی تەواو',
    'form.phone': 'ژمارەی تەلەفۆن',
    'form.message': 'نامە',
    'projects.label': 'دەستکەوتەکانمان',
    'projects.title1': 'پڕۆژە',
    'projects.title2': 'جێبەجێکراوەکان',
    'projects.desc': 'شانازی دەکەین بە کارکردنی بەردەوام لەگەڵ گەورەترین کۆمپانیاکانی عێراق بۆ دابینکردنی چارەسەری کێشانی دروست و متمانەپێکراو.',
    'proj1.title': 'قەپانی بارهەڵگری ١٠٠ تۆن',
    'proj1.cat': 'دانانی نوێ',
    'proj1.loc': 'هەولێر - ناوچەی پیشەسازی',
    'proj2.title': 'سیستەمی کێشانی کۆگا',
    'proj2.cat': 'ئۆتۆمەیشن',
    'proj2.loc': 'سلێمانی - کۆگاکان',
    'proj3.title': 'چاککردنەوە و پشکنینی دەوری',
    'proj3.cat': 'چاککردنەوە',
    'proj3.loc': 'دهۆک - کێڵگەی نەوت',
    'proj4.title': 'قەپانی بارهەڵگری زیرەک',
    'proj4.cat': 'دانانی پێشکەوتوو',
    'proj4.loc': 'بەغدا - سەنتەری لۆجستی',
    'proj5.title': 'نوێکردنەوەی شاشەی قەپان',
    'proj5.cat': 'نوێکردنەوەی سیستەم',
    'proj5.loc': 'موسڵ - کارگەی خۆراک',
    'proj6.title': 'قەپانی سەکۆی هیدرۆلیکی',
    'proj6.cat': 'چارەسەری تایبەت',
    'proj6.loc': 'خورماڵ - پڕۆژەی کشتوکاڵی',
    'form.submit': 'ناردنی نامە',
    'info.title': 'زانیاری پەیوەندیکردن',
    'info.1': 'خزمەتگوزاری کڕیاران',
    'info.2': 'چاککردنەوە و پاڵپشتی پیشەیی',
    'info.3': 'ئیمەیڵ',
    'info.4': 'ناونیشان',
    'info.5': 'ماڵپەڕ',
