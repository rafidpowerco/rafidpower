...
pyarmor gen -O AlRafidain_Secured_Core run_autonomous_brain.py universal_agents.py plugin_market_live.py plugin_deep_memory.py plugin_email_secretary.py llm_engine.py daily_command_center.py run_telegram_bot.py
